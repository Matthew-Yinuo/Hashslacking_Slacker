...
export default ({
  teamName, username,onDMClick, channels, users, onAddChannelClick, teamId, onInvitePeopleClick, isOwner,
}) => (
  <ChannelWrapper>
    <PushLeft>
    ...
    <div>
      <SideBarList>
        <SideBarListHeader>Direct Messages<Icon onClick={onDMClick} name="add circle" />
        </SideBarListHeader>
